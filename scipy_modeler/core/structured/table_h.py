...
table_funcs.py (contains 12 functions)
...
from scipy_modeler.core.server.db import Database, Cursor
...
def _make_categorical_numeric(df : pd.DataFrame,
    ...
    if ( 
        ...
        if inplace:
            ...
            df[
                f"{col}_as_numeric"] = df[col].cat.codes+1
    else:
        pass
